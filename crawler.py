# با اجرای کد زیر و دادن لغت فرش و ادرس جایی که میخواهیم عکس های فرش در انجا ذخیره شود میتوانیم با استفاده از 
# google images
# دیتای مورد نیاز برای عکس فرش را بدست بیاوریم
# برای اجرای این کد علاوه برای کتابخانه های موجود در این 
# script 
# نیاز به chrome driver 
# هم است که یه فایل 
# binary 
# است
# قطعه کد زیر از گرفته شده و تغییرات جزعی روی ان انجام شده
